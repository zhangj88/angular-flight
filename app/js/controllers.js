...
phonecatControllers.controller('Buttons1Ctrl', function ($scope) {
    $scope.singleModel = 1;
...
phonecatControllers.controller('Buttons2Ctrl', function ($scope) {
    $scope.singleModel = 1;
...
phonecatControllers.controller('Buttons3Ctrl', function ($scope) {
    $scope.singleModel = 1;
