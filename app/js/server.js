...
app.get('/flight/research', function(req, res) {
    ...
    request.post({
        ...
        "&ChildQty=" + req.query.child + "&BabyQty=0&AirlineChoice=&HomePortCode=&Dest1PortCode=&CurrentSeqNO=" + (req.query.direction=="First"?"1":"2") + "&DCity=" + req.query.dcity + "&ACity=" + req.query.acity + "&" +
